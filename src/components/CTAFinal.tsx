    ...
    <section className="py-24 bg-black relative z-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-6 mt-12">
          <a
            href="#aviso"
            className="px-12 py-6 rounded-full bg-cyan-primary text-black font-bold text-2xl hover:scale-105 transition-transform shadow-[0_0_50px_rgba(0,242,255,0.4)]"
          >
